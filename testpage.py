...
class OperationsHelpers(BasePage):
    ...
    def click_about_button(self):
        self.click_button(TestSearchLocators.ids["LOCATOR_ABOUT_BTN"], description='about_button')
    ...
    def get_about_text(self):
        return self.get_text_from_element(TestSearchLocators.ids["LOCATOR_TITLE_ABOUT_FIELD"], description='title_about')

    def get_font(self):
        logging.info("Get font size text")
        font_title = self.get_element_property(TestSearchLocators.ids["LOCATOR_TITLE_ABOUT_FIELD"], size_font)
        logging.info(font_title)
        return font_title
